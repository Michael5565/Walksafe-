        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4" onClick={() => { setQrCodeModalLink(null); setQrCodeModalDriverName(null); }}>
          <div className="bg-white w-full max-w-md border border-border-subtle shadow-xl overflow-hidden" onClick={e => e.stopPropagation()} style={{ borderRadius: '0.5rem' }}>
            ...
            <div className="bg-surface-container-low p-4 text-center border-t border-border-subtle">
              <p className="text-[10px] uppercase tracking-widest font-bold text-zinc-400">Secure Authentication Protocol Active
      ...
      {showTour && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={() => setShowTour(false)}>
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              <div className="flex gap-3 p-3 bg-blue-50 rounded-lg"><span className="w-7 h-7 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0 text-xs">1</span><div><p className="font-semibold text-sm">Dashboard Overview</p><p className="text-xs text-gray-500">Check today status, open defects, fleet health</p></div></div>
              <div className="flex gap-3 p-3 bg-blue-50 rounded-lg"><span className="w-7 h-7 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0 text-xs">2</span><div><p className="font-semibold text-sm">Add Vehicles & Drivers</p><p className="text-xs text-gray-500">Register with DVLA lookup, assign PINs</p></div></div>
              ...
              <div className="flex gap-3 p-3 bg-blue-50 rounded-lg"><span className="w-7 h-7 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0 text-xs">4</span><div><p className="font-semibold text-sm">Schedule & Track</p><p className="text-xs text-gray-500">Set recurring checks, export PDF audits</p></div></div>
            </div>
